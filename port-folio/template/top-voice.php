        ...
        <div class="p-archive-voice__content p-top-voice__content">
            ...
            if ($voice_query->have_posts()) : ?>
                ...
                <div class="p-archive-voice__btn">
                    <a href="<?php echo get_post_type_archive_link('voice'); ?>" class="c-btn__link">Read more
                        <span class="c-btn--circle"></span></a>
                </div>

            <?php else : ?>

                <div class="p-top-voice__empty">
                    <p class="p-top-voice__empty-text">現在、お客様の声を準備中です。公開まで今しばらくお待ちください。</p>
                </div>
