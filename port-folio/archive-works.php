...
<section class="p-archive-works l-archive-works">
    <div class="p-archive-works__container">
        <div class="p-archive-works__inner l-inner">
                    ...
                    if (have_posts()) : ?>
                        <?php while (have_posts()) : the_post(); ?>
                            <li class="p-archive-works__card-item">
                                <article class="p-archive-works__card">
                                    <a href="<?php the_permalink(); ?>" class="p-archive-works__card-link">
            ...
            <?php else : ?>
                <div class="p-archive-works__empty">
                    <p class="p-archive-works__empty-text">現在、実績を準備中です。公開まで今しばらくお待ちください。</p>
                </div>
            <?php endif; ?>
