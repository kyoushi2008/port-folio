...
<body <?php body_class(); ?>>
    ...
    <header class="p-header l-header js-header">
        <div class="p-header__wrapper">
            ...
            <?php else: ?>
            <!-- 下層ページの場合はdiv -->
            <div class="p-header__logo js-header">
                <a href="<?php echo esc_url(home_url('/')); ?>" class="p-header__logo-image js-header">CODE ASSIST</a>
            </div>
            <?php endif; ?>
            <!-- sp contactボタン -->
            <a href="<?php echo esc_url(home_url('/contact/')); ?>" class="p-header__sp-contact-btn"
                target="_blank"></a>
                ...
                <div class="p-header__nav-inner">
                    <div class="p-header__nav-inner2">
                        ...
                        <ul class="p-header__nav-list">
                            ...
                            <?php $item = $node['item']; ?>
                            <!-- 親メニューの情報を取り出す -->
                            <li class="p-header-nav-item p-header__nav-item js-accordion">
                                <!-- 親メニューのli -->
                            ...
                            <!-- 親メニューのループ終了 -->
                            <?php endif; ?>
                            <!-- メニュー項目が空でない場合のチェック終了 -->
                            <li class="p-header__btn-item p-header-nav-item p-header__nav-item">
                                <a href="<?php echo esc_url(home_url('/contact/')); ?>"
                                    class="p-header__btn-link p-header-nav-item__link">CONTACT</a>
                            </li>
                        </ul>
                    </div>
                </div>
